...
@section('scriptHead')
<title>Kategori Surat Masuk</title>
...
<div class="container-fluid p-0">
    <h1 class="h3 mb-3">Kategori Surat Masuk</h1>
    <div class="row">
        <div class="col-12">
            <div class="card">
        ...
        <form id="myForm">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-label">Form Kategori Surat Masuk</h5>
                ...
                <div class="modal-body ">
                    <div class="row">
						<div class="col-lg-9 mb-3">
                            ...
                            <input name="kategori" id="kategori" type="text" class="form-control" placeholder="" required>
                        </div>
