...
<div class="container-fluid p-0">
    <h1 class="h3 mb-3">Akses Disposisi</h1>
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="modal-body ">
                    <div class="row">
						...
						<div class="col-lg-4 mb-3">
                            ...
                            <select name="spesimen_jabatan_id" id="spesimen_jabatan_id" class="form-control" required></select>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    var vApi='/api/akses-disposisi';
    var vJudul='Akses Disposisi';
    ...
    function simpan(setup_ajax,form) {
        ...
        $.each(user_id, function(index, usrDt) {
            let dataForm={
                tahun:tahun,
                user_id:usrDt,
                spesimen_jabatan_id:spesimen_jabatan_id,
            }
    ...
    $(document).ready(function() {
        ...
        function loadData(page = 1) {
            CrudModule.setFilter(`{"tahun":"${tahunFilter}"}`);
            CrudModule.fRead(page, displayData);
        }
