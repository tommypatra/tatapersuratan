...
<div class="container-fluid p-0">
    <h1 class="h3 mb-3">Pola Surat Keluar</h1>
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="modal-body ">
                    <div class="row">
						...
						<div class="col-lg-6 mb-3">
                            ...
                            <input name="pola" id="pola" type="text" class="form-control" required>
                        </div>
						<div class="col-lg-6 mb-3">
...
<script type="text/javascript">
    ...
    var vApi='/api/pola-surat-keluar';
    var vJudul='Pola Surat Keluar';
    var fieldInit={
        'id': { action: 'val' },
        'kategori': { action: 'val' },
        'pola': { action: 'val' },
