...
<div class="container-fluid p-0">
    <h1 class="h3 mb-3">Spesimen Jabatan</h1>
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="modal-body ">
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-3">
                            ...
                            <select class="form-control" id="user_pejabat_id" name="user_pejabat_id" required></select>
                        </div>
...
<script type="text/javascript">
    ...
    var fieldInit={
        ...
        'user_pejabat_id': { action: 'select2' },
    ...
    $.ajax({
        ...
        success: function (response){
            ...
            sel2_datalokal('#user_pejabat_id',vdata,false,'#myForm .modal-content');
        },
